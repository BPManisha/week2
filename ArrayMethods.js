...
console.log(evenNumbers);// this should print only even numbers doing a rework as lost original file.
...
// CODE HERE
const afterTaxSum = orders.map(order => order.price*(1+order.tax) )
console.log(afterTaxSum);
